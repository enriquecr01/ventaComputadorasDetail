...
function PopupWindow(title, width, height) 
{
	...
	PopupWindow.prototype.message = 'ERROR AL ENTRAR';
	...
	{
		console.log(this.functionCancel);
		//create glass
		...
		popupClose.innerHTML = "<img src='img/close.png' width='30px'>";
		...
		label.innerHTML = 'Error al intentar ingresar al sistema';
	...
	PopupWindow.prototype.content = function(text)
	{
		this.message = text;
	}
