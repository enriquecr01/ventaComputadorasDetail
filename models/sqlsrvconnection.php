<?php
	...
	class SqlSrvConnection {
		...
		public static function getConnection() {
			...
			$configPath = $_SERVER['DOCUMENT_ROOT'].'/ventaComputadoras/config/sqlsrvconnection.json';
		...
		public static function getConnectionVendedor() {
			//open configuration file
			$configPath = $_SERVER['DOCUMENT_ROOT'].'/ventaComputadoras/config/seller.json';
			$configData = json_decode(file_get_contents($configPath),true);
			//check parameters
			if (isset($configData['server']))
				$server = $configData['server'];
		...
		{
			//open configuration file
			$configPath = $_SERVER['DOCUMENT_ROOT'].'/ventaComputadoras/config/admin.json';
			$configData = json_decode(file_get_contents($configPath),true);
			//check parameters
			if (isset($configData['server']))
				$server = $configData['server'];
